        ...
        <div className={styles.comteneur_general}>
            ...
            <div className={styles.conteneur_info}>
              ...
              <div className={styles.conteneur_info_construction}>
                <div className={styles.icon}>
                  ...
                  <p className={styles.p}> {detail.data.dateDebut}</p>
                </div>
                <div className={styles.icon}>
                  <span>{Icones.annee} Date Fin</span>
                  <p className={styles.p}> {detail.data.dateFin}</p>
                </div>
                <div className={styles.icon}>
                  <span>{Icones.surface} Superficie </span>
                  <p className={styles.p}>{detail.data.superficie}</p>
                </div>
                <div className={styles.icon}>
                  <span>{Icones.lieu} Lieu</span>
                  <p className={styles.p}>{detail.data.lieu}</p>
                </div>
                <div className={styles.icon}>
                  <span>{Icones.client} Client</span>
                  <p className={styles.p}>{detail.data.client}</p>
                </div>
                <div className={styles.icon}>
                  {Icones.statut}
                  Status
                  <p className={styles.p}> {detail.data.status}</p>
                </div>
              </div>
          ...
          <div className={styles.conteneur_dif}>
            ...
            <p>
              ...
              accusantium nihil laboriosam enim praesentium ea, fugiat a,
              facilis dignissimos quasi repellendus?
            </p>
            <h2 className={styles.sTitre}>
            ...
            <p>
              ...
              sint consectetur ad libero, velit reiciendis necessitatibus quis
              laboriosam quos quasi enim corporis labore, aliquam nulla beatae
              porro tempore blanditiis cum.
            </p>
          </div>
